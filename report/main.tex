...
\graphicspath{
  ...
  {static/images/4.1-Event1/}
  {static/images/4.2-Event2/}
  {static/images/4.3-Event3/}
  {static/images/5-Workshop/}
  {content/2-Proposal/}
  {content/5-Workshop/5.1-Ideas_and_Goals/}
  {content/5-Workshop/5.2-Prerequisites/}
  {content/5-Workshop/5.3-Backend_Deployment/}
  {content/5-Workshop/5.4-Frontend_Deployment/}
  {content/5-Workshop/5.5-Testing_and_Validation/}
  {content/5-Workshop/5.6-Cleanup/}
}
