...
* Kết luận: Sau quá trình tìm hiểu và xây dựng dự án, điều thay đổi lớn nhất trong suy nghĩ của mình là Serverless không chỉ xoay quanh AWS Lambda. Một hệ thống Serverless hoàn chỉnh là sự phối hợp của nhiều dịch vụ như API Gateway, Cognito, DynamoDB, IAM và các cơ chế bảo mật khác.
